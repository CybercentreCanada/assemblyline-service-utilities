...
@pytest.mark.parametrize("data,domain", [(b"config.edge.skype.com0", b"config.edge.skype.com")])
...
@pytest.mark.parametrize(
    "url", [b"https://www.google.com.account.login:.@example.com", b"https://@example.com", b"https://:@example.com"]
)
